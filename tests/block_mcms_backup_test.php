 ...
 * @copyright 2020 - CALL Learning - Laurent David <laurent@call-learning.fr>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \restore_mcms_block_task
 */
...
EOT;
     ...
     * @covers \restore_mcms_block_decode_content::get_iterator
     */
    public function test_backup_restore() {
        ...
        $frontpage = $DB->get_record('course', ['id' => SITEID]);
        ...
        $contentimages = []; // No more images.
        $images = ['other-image.jpg' => 'icon.jpg'];
