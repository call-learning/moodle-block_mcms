...
class block_mcms_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_decorations', get_string('config:decorations', 'block_mcms'), ['size' => 250]);
        ...
        $mform->addGroup($radioarray, 'configlayoutarray', get_string('config:layout', 'block_mcms'), [' '], false);
